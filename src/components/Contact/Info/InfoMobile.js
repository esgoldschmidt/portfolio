...
export class InfoMobile extends React.Component {
    render() {
           return (
               <div className='InfoMain' style={styles.mobileInfoMain}>
                ...
                <img src={workStation} alt='Work Station' style={styles.mobileWorkStation}/>
               </div>    
           )
       }
    }