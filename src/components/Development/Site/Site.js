        ...
        <div className="Brand">
            ...
            <h2 className='projectsHead' style={styles.brandHead}>Select Projects</h2>
                ...
                <div className='projects' style={styles.projectContainer}>
                    ...
                    <button onClick={this.showMoreLettr} style= {styles.button}>
                        More &#9660;
                    </button>
                </div>
                ...
                : (
                    ...
                    <div className='projects' style={styles.projectContainer}>
                        ...
                        <button onClick={this.showMoreRosie} style= {styles.button}>
                            More &#9660;
                        </button>
                    </div>
                    <div style={styles.showMoreContainer}>
                ...
                : (
                    ...
                    <div className='projects' style={styles.projectContainer}>
                        ...
                        <button onClick={this.showMoreRB} style= {styles.button}>
                            More &#9660;
                        </button>
                    </div>
                    <div style={styles.showMoreContainer}>
                ...
                ? (
                    ...
                    >
                    <img src={moreRB} alt="Renting Brooklyn" style={styles.moreImage}/>
                    </div>
                )
                : (
                    null
                    ...
                    <div className='projects' style={styles.projectContainer}>
                        ...
                        <button onClick={this.showMoreEventurous} style= {styles.button}>
                            More &#9660;
                        </button>
                    </div>
                    <div style={styles.showMoreContainer}>
                ...
                : (
                    ...
                    <div className='projects' style={styles.projectContainer}>
                        <img src={Subway} alt="Subway Realty" style={styles.image}/>
                        <button onClick={this.showMoreSubway} style= {styles.button}>
                            More &#9660;
                        </button>
                    </div>
                    <div style={styles.showMoreContainer}>
                ...
                ? (
                    ...
                    >
                    <img src={moreSubway} alt="Subway" style={styles.moreImage}/>
                    </div>
                )
                : (
                    null
